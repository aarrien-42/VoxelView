...
std::vector<Vertex> vertices {
	// FRONT
	{glm::vec3 (-0.5f, -0.5f,  0.5f), glm::vec3 ( 0.0f,  0.0f,  1.0f), glm::vec2 (0.0f, 0.0f), glm::vec1(0.0f)}, // 0 => Bottom Left
	{glm::vec3 ( 0.5f, -0.5f,  0.5f), glm::vec3 ( 0.0f,  0.0f,  1.0f), glm::vec2 (1.0f, 0.0f), glm::vec1(0.0f)}, // 1 => Bottom Right
	{glm::vec3 ( 0.5f,  0.5f,  0.5f), glm::vec3 ( 0.0f,  0.0f,  1.0f), glm::vec2 (1.0f, 1.0f), glm::vec1(0.0f)}, // 2 => Top Right
	...
	{glm::vec3 (-0.5f, -0.5f,  0.5f), glm::vec3 (-1.0f,  0.0f,  0.0f), glm::vec2 (1.0f, 0.0f), glm::vec1(0.0f)}, // 9
	{glm::vec3 (-0.5f,  0.5f,  0.5f), glm::vec3 (-1.0f,  0.0f,  0.0f), glm::vec2 (1.0f, 1.0f), glm::vec1(0.0f)}, // 10
	...
	{glm::vec3 ( 0.5f, -0.5f, -0.5f), glm::vec3 ( 0.0f, -1.0f,  0.0f), glm::vec2 (1.0f, 0.0f), glm::vec1(2.0f)}, // 21
	{glm::vec3 ( 0.5f, -0.5f,  0.5f), glm::vec3 ( 0.0f, -1.0f,  0.0f), glm::vec2 (1.0f, 1.0f), glm::vec1(2.0f)}, // 22
	{glm::vec3 (-0.5f, -0.5f,  0.5f), glm::vec3 ( 0.0f, -1.0f,  0.0f), glm::vec2 (0.0f, 1.0f), glm::vec1(2.0f)}  // 23
};
